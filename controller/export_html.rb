			...
			if !comp_dicts.nil? && !comp_dicts['carcase_spec'].nil?
				comp_dicts['carcase_spec'].each{|key, val|
					if key.include?('lam_value')
						split = val.split('/')[-1]
						lam_name = split.gsub(".jpg", "").gsub(".JPG", "")
						lam_json[lam_name] = RIO_ROOT_PATH + '/materials/' + val
					end
				}
			end
		}
		...
		<head>
		  ...
		  <link href="https://fonts.googleapis.com/css?family=Poppins" rel="stylesheet">
			...
			<style>
				...
				.laming10 {margin-left:-5px; text-align:center;}
				.laming10 span {padding-left:5px;}
				.laming10 img {height:30px;width:100%;margin-left:5px;}
...
str +=				'<div class="ui equal width grid" style="margin:0px;border-bottom:1px solid black;">
									...
									<div class="column brht">'+pro_code+'</div>
